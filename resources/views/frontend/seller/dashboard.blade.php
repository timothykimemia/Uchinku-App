                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="bg-white mt-4 p-5 text-center">
                                    ...
                                    @if(Auth::user()->seller->verification_status == 0)
                                        <a href="{{ route('shop.verify') }}" class="btn btn-styled btn-base-1">{{__(' Verify Your Vendor Account ')}}</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                {{-- <div class="bg-white mt-4 p-4 text-center">
                                    <div class="heading-4 strong-700">{{__('Shipping')}}</div>
                                    <p>{{__('Manage & organize your shop')}}</p>
                                    <a href="{{ route('shipping_agents.index') }}" class="btn btn-styled btn-base-1 btn-outline btn-sm">{{__('Go to setting')}}</a>
                                </div> --}}
                                <div class="bg-white mt-4 p-4 text-center">
