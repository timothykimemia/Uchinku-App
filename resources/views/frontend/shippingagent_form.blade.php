                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('shipping_agents.create') }}">{{__('Create Shipping ag')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form class="" action="{{ route('shipping_agents.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if (!Auth::check())
