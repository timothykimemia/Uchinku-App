...
class AffiliateController extends Controller
{
    ...
    public function apply_for_affiliate(Request $request){
        return view('shippingagent.frontend.apply_for_affiliate');
    }
    ...
    public function users(){
        ...
        return view('shippingagent.users', compact('affiliate_users'));
    }

    public function show_verification_request($id){
        $affiliate_user = AffiliateUser::findOrFail($id);
        return view('shippingagent.show_verification_request', compact('affiliate_user'));
    }
    ...
    {
        $affiliate_user = AffiliateUser::findOrFail($request->id);
        return view('shippingagent.payment_modal', compact('affiliate_user'));
    }
    ...
    public function payment_history($id){
        ...
        return view('shippingagent.payment_history', compact('affiliate_payments', 'affiliate_user'));
    }

    public function user_index(){
        $affiliate_user = Auth::user()->affiliate_user;
        $affiliate_payments = $affiliate_user->affiliate_payments();
        return view('shippingagent.frontend.index', compact('affiliate_payments'));
    }

    public function payment_settings(){
        $affiliate_user = Auth::user()->affiliate_user;
        return view('shippingagent.frontend.payment_settings', compact('affiliate_user'));
    }
